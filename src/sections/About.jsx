...
const stats=[
  ...
  const glows = [
    "top-10 left-10 w-[560px] h-[360px] opacity-20 blur-[120px]",
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        {glows.map((c, i) => (
          <div
            key={i}
            className={`absolute rounded-full bg-gradient-to-r from-[#302b63] via-[#00bf8f] to-[#1c8d82] animate-pulse ${c}`}
          />
        ))}
      </div>
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          <motion.div className= "relative w-[160px] md:w-[200px] md:h-[200px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1c8d82]/20 to-[#302b63]/20 border border-[#1cd8d2]/25"
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#1c8d82] via-[#00bf8f] to-[#1cd8d2]">
              Neej Butani
            </h2>
...
>
  ...
  <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
    👨‍💻 Software Developer, Content Creator, and Web Developer — passionate about building fast, resilient applications and sharing coding insights on Instagram and YouTube.
  </p>
