...
const socials = [
  { Icon: FaXTwitter, label: "X", href: "https://twitter.com/neejbutani" },
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/neejbutani/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/neejbutani" }
]
...
const roles = useMemo(() => ["Full Stack Developer", "UI/UX Designer", "Tech Enthusiast"], []);
...
<div
  ...
  style={{
    ...
    filter: "blur(38px)",
    opacity: 0.32,
    background: "conic-gradient(from 0deg, #1c8d82, #00bf8f, #30b263, #1c8d82)"
  }}
/>


<motion.img src={avatar} alt= "Neej"
